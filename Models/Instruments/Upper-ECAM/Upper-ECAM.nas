...
var canvas_upperECAM_base = {
	...
	updateBase: func() {
		# Reversers
		if (getprop("/engines/engine[0]/reverser-pos-norm") >= 0.01 and getprop("/systems/fadec/eng1/n1") == 1 and getprop("/options/eng") == "GE") {
			me["REV1"].show();
			me["REV1-box"].show();
		} else if (getprop("/engines/engine[0]/reverser-pos-norm") >= 0.01 and getprop("/systems/fadec/eng1/epr") == 1 and (getprop("/options/eng") == "PW" or getprop("/options/eng") == "RR")) {
			me["REV1"].show();
			me["REV1-box"].show();
		} else {
			me["REV1"].hide();
		...
		if (getprop("/engines/engine[1]/reverser-pos-norm") >= 0.01 and getprop("/systems/fadec/eng2/n1") == 1 and getprop("/options/eng") == "GE") {
			me["REV2"].show();
			me["REV2-box"].show();
		} else if (getprop("/engines/engine[1]/reverser-pos-norm") >= 0.01 and getprop("/systems/fadec/eng2/epr") == 1 and (getprop("/options/eng") == "PW" or getprop("/options/eng") == "RR")) {
			me["REV2"].show();
			me["REV2-box"].show();
		} else {
			me["REV2"].hide();
		...
		if (getprop("/ECAM/msg/line1c") == "w") {
			...
			me["ECAML1"].setColor(0.0862,0.5176,0.6470);
		...
		if (getprop("/ECAM/msg/line2c") == "w") {
			...
			me["ECAML2"].setColor(0.0862,0.5176,0.6470);
		...
		if (getprop("/ECAM/msg/line3c") == "w") {
			...
			me["ECAML3"].setColor(0.0862,0.5176,0.6470);
		...
		if (getprop("/ECAM/msg/line4c") == "w") {
			...
			me["ECAML4"].setColor(0.0862,0.5176,0.6470);
		...
		if (getprop("/ECAM/msg/line5c") == "w") {
			...
			me["ECAML5"].setColor(0.0862,0.5176,0.6470);
		...
		if (getprop("/ECAM/msg/line6c") == "w") {
			...
			me["ECAML6"].setColor(0.0862,0.5176,0.6470);
		...
		if (getprop("/ECAM/msg/line7c") == "w") {
			...
			me["ECAML7"].setColor(0.0862,0.5176,0.6470);
		...
		if (getprop("/ECAM/msg/line8c") == "w") {
			...
			me["ECAML8"].setColor(0.0862,0.5176,0.6470);
...
var canvas_upperECAM_ge = {
	...
	getKeys: func() {
		...
		"EGT2","EGT2-scale","EGT2-box","EGT2-scale2","EGT2-scaletick","EGT2-XX","N22","N22-decpnt","N22-decimal","N22-XX","FF2","FF2-XX","FOB-LBS","ECAML1","ECAML2","ECAML3","ECAML4","ECAML5","ECAML6","ECAML7","ECAML8","FlapTxt","FlapDots","N1Lim-mode",
		"N1Lim","N1Lim-decpnt","N1Lim-decimal","N1Lim-percent","N1Lim-XX","N1Lim-XX2","REV1","REV1-box","REV2","REV2-box"];
	},
	update: func() {
		# N1
...
var canvas_upperECAM_pwrr = {
	...
	getKeys: func() {
		...
		"N12-scale","N12-scale2","N12-scaletick","N12-scalenum","N12-XX","N22Label","N22","N22-decpnt","N22-decimal","N22-XX","FF2","FF2-XX","FOB-LBS","ECAML1","ECAML2","ECAML3","ECAML4","ECAML5","ECAML6","ECAML7","ECAML8","FlapTxt","FlapDots","EPRLim-mode",
		"EPRLim","EPRLim-decpnt","EPRLim-decimal","EPRLim-XX","EPRLim-XX2","REV1","REV1-box","REV2","REV2-box"];
	},
	update: func() {
		# EPR
...
setlistener("sim/signals/fdm-initialized", func {
	...
	upperECAM_test = canvas_upperECAM_test.new(group_test, "Aircraft/IDG-A33X/Models/Instruments/Common/res/du-test.svg");
