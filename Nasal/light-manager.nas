...
var light_manager = {
	...
	update: func {
		...
		if (als_on == 1 and alt_agl < 100.0) {
			...
			if (ll1 == 1 and getprop("/systems/electrical/bus/ac1") != 0 and getprop("/systems/electrical/bus/ac2") !=0) {
				me.light1_ypos =  0.0;
				me.light1_setSize(18);
				me.light1_on();
			} else if (ll1 == 1 and getprop("/systems/electrical/bus/ac1") != 0) {
				me.light1_ypos =  3.0;
				me.light1_setSize(12);
				me.light1_on();
			} else if (ll1 == 1 and getprop("/systems/electrical/bus/ac2") != 0) {
				me.light1_ypos =  -3.0;
				me.light1_setSize(12);
				me.light1_on();
			} else {
