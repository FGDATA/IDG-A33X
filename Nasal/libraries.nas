...
print("   /  \    __) |__) | | | | |__ __ _ _ __ ___  _| |_   _ ");
print("  / /\ \  |__ <|__ <| | | |  __/ _` | '_ ` _ \| | | | | |");
print(" / ____ \ ___) |__) | |_| | | | (_| | | | | | | | | |_| |");
...
setlistener("/sim/signals/fdm-initialized", func {
	...
	mcdu1.MCDU_init();
	mcdu2.MCDU_init();
	var autopilot = gui.Dialog.new("sim/gui/dialogs/autopilot/dialog", "Aircraft/A330Family/Systems/autopilot-dlg.xml");
...
var aglgears = func {
    ...
    var aglft = agl - 15.169;  # is the position from the Airbus A330 above ground
...
setlistener("/options/drogue-cmd", func {
	var boomPos = getprop("/options/drogue-cmd");
	if (boomPos == 1) {
		setprop("/options/drogue-cmd", 1);
		interpolate("/options/drogue-pos-norm", 1, 1.5);
	} else {
		setprop("/options/drogue-cmd", 0);
